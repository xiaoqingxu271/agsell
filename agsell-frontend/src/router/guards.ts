  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'users',
        name: 'AdminUsers',
        component: () => import('@/views/admin/list/UserListView.vue'),
        meta: { title: '用户管理' },
      },
      {
        path: 'categories',
        name: 'AdminCategories',
        component: () => import('@/views/admin/list/CategoryListView.vue'),
        meta: { title: '分类管理' },
      },
      {
        path: 'products',
        name: 'AdminProducts',
        component: () => import('@/views/admin/list/ProductListView.vue'),
        meta: { title: '商品管理' },
      },
      {
        path: 'orders',
        name: 'AdminOrders',
        component: () => import('@/views/admin/list/OrderListView.vue'),
        meta: { title: '订单管理' },
      },
      {
        path: 'reviews',
        name: 'AdminReviews',
        component: () => import('@/views/admin/list/ReviewListView.vue'),
        meta: { title: '评价管理' },
      },
      {
        path: 'banners',
        name: 'AdminBanners',
        component: () => import('@/views/admin/list/BannerListView.vue'),
        meta: { title: '轮播图管理' },
      },
      {
        path: 'after-sales',
        name: 'AdminAfterSales',
        component: () => import('@/views/admin/list/AfterSalesListView.vue'),
        meta: { title: '售后管理' },
      },
      {
        path: 'traceability',
        name: 'AdminTraceability',
        component: () => import('@/views/admin/list/TraceabilityListView.vue'),
        meta: { title: '产地溯源' },
      },
      {
        path: 'seckill',
        name: 'AdminSeckill',
        component: () => import('@/views/admin/list/SeckillListView.vue'),
        meta: { title: '秒杀管理' },
      },
      {
        path: 'hot-word',
      ...
      },
      {
        ...
        component: () => import('@/views/admin/list/AdminListView.vue'),
        meta: { title: '管理员管理' },
      },
      {
        path: 'system/config',
      ...
      },
      {
        path: 'system/log',
        name: 'AdminSystemLog',
        component: () => import('@/views/admin/system/OperationLogView.vue'),
        meta: { title: '操作日志' },
      },
    ],
  },
